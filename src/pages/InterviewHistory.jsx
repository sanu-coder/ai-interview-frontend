            ...
            <div className='grid gap-3'>
              {
                interviews.map((item, index) => (
                  ...
                  className='bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transitionall duration-300 cursor-pointer border border-gray-100'>
                    <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
                      <div>
                        ...
                        <p className='text-sx text-gray-400 mt-2'>
