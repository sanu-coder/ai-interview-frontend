  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 py-16 px-6'>
      <div className="max-w-6xl mx-auto mb-14 flex items-start gap-4">
        <button className="mt-2 p-3 rounded-full bg-white shadow hover:shadowmd transiton" 
        onClick={()=> navigate("/")}
        >
        ...
        <div className="text-center w-full">
          ...
          <p className="text-gray-500 mt-3 text-lg">
            Flexibile pricing to match your interview preparation goals.
          </p>
        </div>
      </div>
...
// DUMMY CARD DETAILS : 
// 4100 2800 0000 1007
// Any future date and any digit as CSV