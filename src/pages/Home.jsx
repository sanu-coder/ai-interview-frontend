        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className="text-center mb-28">
              ...
              className='text-gray-500 mt-6 max-w-2xl mx-auto text-lg'>
                Role-based interviews with smart follow-ups, adaptive difficulty and real-time performance evaluation
              </motion.p>
              <div className="fle flex-wrap justify-center gap-4 mt-10">
                <motion.button
                onClick={()=>{
                  if(!userData){
                    setShowAuth(true);
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-10 mb-28">
              {
                [
                  ...
                  },
                  {
                    ...
                    desc : "Dyanamic followup questions based on your answers."
                  },
                  {
                  ...
                  [
                    {
                      ...
                      desc : "Behavourial and communication based evaluation."
                    },
                    {
                      image : techImg,
