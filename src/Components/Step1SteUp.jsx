        ...
        >
            ...
            <div className="space-y-6">
              <div className="relative">
                ...
                className='w-full pl-12 px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'
                onChange={(e) => setRole(e.target.valueAsDate)}
                value={role}
                />
              </div>
              ...
              <div className="relative">
                ...
                className='w-full pl-12 px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'
                onChange={(e) => setExperience(e.target.valueAsDate)}
                value={role}
                />
              </div>
